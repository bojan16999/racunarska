...
#define LED 25 // WiringPi broj pina za LED
...
int main(void)
{
    ...
    // Inicijalizacija WiringPi biblioteke
    wiringPiSetup();
    pinMode(LED, OUTPUT);
    ...
    while (1)
    {
        ...
        zapis(temp); //upis u datoteku
    }
    return 0;
}
U ovom kodu dodali smo definiciju pina za LED diodu
